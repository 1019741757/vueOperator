...
<div class="wraper personinfo-wrap">
  ...
  <div class="innerwrap">
    <div class="info-content">
      ...
      <!-- 表格 -->
      <el-table :data="IntegralRewardList.Object" tooltip-effect="dark" border style="width: 100%" :header-cell-style="{background:'rgb(220, 223, 230)',color:'#333'}">
        <el-table-column property="Id" sortable label="任务ID"></el-table-column>
        <el-table-column property="Title" label="任务名称"></el-table-column>
        <el-table-column property="CompleteCount" sortable label="累计完成次数"></el-table-column>
        <el-table-column property="IntegralRewardSum" sortable label="累计奖励灵石数"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getData: function() {
      ...
      this.vq.bindTo({
        url: "/api/IntegralTask/IntegralRewardList",
        type: 'get',
        data: _data,
        loader: true,
        addfn: function(res) {
