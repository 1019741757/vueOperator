    ...
    <div class="info-content">
      ...
      <div>
        <el-form :inline="true" class="demo-form-inline" style="padding: 0 5px">
          <el-form-item label="抽奖日期：" style="margin-bottom: 5px">
          ...
          <el-form-item style="width:10%">
            <el-input v-model="prizeName" auto-complete="off" placeholder="请输入奖品名称" clearable @clear="onSubmit" @keyup.enter.native="onSubmit"></el-input>
          </el-form-item>
      ...
      <el-table :data="DataList" tooltip-effect="dark" border style="width: 100%" :header-cell-style="{background:'rgb(220, 223, 230)',color:'#333'}">
        <el-table-column property="CreateTime" label="抽奖时间"></el-table-column>
        <el-table-column property="ConsumerId" label="用户ID" width="180"></el-table-column>
        <el-table-column property="ConsumerPhone" label="用户手机号"></el-table-column>
        <el-table-column property="PrizeName" label="奖品名称"></el-table-column>
        <el-table-column property="Integral" label="消耗积分数" width="180"></el-table-column>
        <el-table-column property="NetbarId" label="网吧ID"></el-table-column>
        <!-- <el-table-column property="PrizeName" label="网吧名称"></el-table-column> -->
      </el-table>
...
export default {
  ...
  methods: {
    ...
    getData: function() {
      ...
      this.vq.bindTo({
        url: "/api/Lottery/GetLotteryRecordList",
        type: 'get',
        data: _data,
        loader: true,
        addfn: function(res) {
